      ...
      <x-slot name="body">
         ...
         <div class="row">
            ...
            <div class="col-12 col-md-7">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="endereco_rua" name="endereco_rua" value="{{ $encontrista->endereco_rua }}" placeholder="Rua" required>
         ...
         <div class="row">
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="endereco_bairro" name="endereco_bairro" value="{{ $encontrista->endereco_bairro }}" placeholder="Bairro" required>
                  <label for="endereco_bairro">* Bairro</label>
               </div>
            </div>
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="endereco_cidade" name="endereco_cidade" value="{{ $encontrista->endereco_cidade }}" placeholder="Cidade" required>
                  <label for="endereco_cidade">* Cidade</label>
               </div>
            </div>
            <div class="col-12 col-md-2">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="endereco_estado" name="endereco_estado" value="{{ $encontrista->endereco_estado }}" placeholder="Estado" required maxlength="2" pattern="[A-Z]{2}" title="Informe apenas a sigla do estado, por exemplo: PB, SP, RJ.">
                  <label for="endereco_estado">* Estado</label>
               </div>
            </div>
            <div class="col-12 col-md-4">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="endereco_complemento" name="endereco_complemento" value="{{ $encontrista->endereco_complemento }}" placeholder="complemento">
         ...
         <div class="row">    
            <div class="col-12 col-md-2">
               <div class="form-floating mb-2">
                  <select class="form-select" id="estuda" name="estuda" required>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->estuda == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-5">   
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="escola" name="escola" value="{{ $encontrista->escola }}" placeholder="escola" disabled>
            ...
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                  <select class="form-select" id="serie" name="serie" disabled>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->serie == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-2">
               <div class="form-floating mb-2">
                  <select class="form-select" id="turno" name="turno" disabled>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->turno == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                  <select class="form-select" id="tem_irmaos" name="tem_irmaos" required>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->tem_irmaos == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
         ...
         <div class="row">
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="outro_responsavel_nome" name="outro_responsavel_nome" value="{{ $encontrista->outro_responsavel_nome }}" placeholder="Pai">
                  <label for="outro_responsavel_nome">Outro responsável</label>
               </div>
            </div>
            <div class="col-12 col-md-4">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control maskContato" id="outro_responsavel_contato" name="outro_responsavel_contato" value="{{ $encontrista->outro_responsavel_contato }}" placeholder="Contato do Pai">
                  <label for="outro_responsavel_contato">Contato do Responsável</label>
               </div>
            </div>
            <div class="col-12 col-md-2">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="outro_responsavel_parentesco" name="outro_responsavel_parentesco" value="{{ $encontrista->outro_responsavel_parentesco }}" placeholder="Contato do Pai">
         ...
         <div class="row">    
            <div class="col-12 col-md-4">
               <div class="form-floating mb-2">
                  <select class="form-select" id="contato_principal" name="contato_principal" required>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->contato_principal == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-4">
               <div class="form-floating mb-2">
                  <select class="form-select" id="possui_transporte" name="possui_transporte" required>                     
                     ...
                     <option value="{{ $key }}" {{ $encontrista->possui_transporte == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-4">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="mora_com" name="mora_com" value="{{ $encontrista->mora_com }}" placeholder="mora_com" required>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                     <select class="form-select" id="familiar_participa" name="familiar_participa" title="Grupo, pastoral, serviço ou movimento ?" required>
                        @foreach($simNao as $key => $dado)                     
                        <option value="{{ $key }}" {{ $encontrista->familiar_participa == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                        @endforeach
                     </select>
            ...
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                     <input type="text" class="form-control text-uppercase" id="familiar_quem" name="familiar_quem" value="{{ $encontrista->familiar_quem }}" placeholder="Quem ?" disabled>
            ...
            <div class="col-12 col-md-3">
               <div class="form-floating mb-2">
                     <input type="text" class="form-control text-uppercase" id="familiar_grupo" name="familiar_grupo" value="{{ $encontrista->familiar_grupo }}" placeholder="Grupo, pastoral, serviço ou movimento" disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="tem_parente_inscrito" name="tem_parente_inscrito" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->tem_parente_inscrito == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="parente_inscrito_nome" name="parente_inscrito_nome" value="{{ $encontrista->parente_inscrito_nome }}" placeholder="Nome(s) do(s) parente(s)" disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="uso_medicamento" name="uso_medicamento" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->uso_medicamento == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="uso_medicamento_descricao" name="uso_medicamento_descricao" value="{{ $encontrista->uso_medicamento_descricao }}" placeholder="Detalhar com horários, quantidades e enviar na mala!" disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="tratamento_saude" name="tratamento_saude" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->tratamento_saude == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="tratamento_saude_descricao" name="tratamento_saude_descricao" value="{{ $encontrista->tratamento_saude_descricao }}" placeholder="Detalhar a necessidade de acompanhamento." disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="restricao_alimentar" name="restricao_alimentar" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->restricao_alimentar == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="restricao_alimentar_descricao" name="restricao_alimentar_descricao" value="{{ $encontrista->restricao_alimentar_descricao }}" placeholder="Detalhar a restrição alimentar." disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="alergia" name="alergia" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->alergia == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
                  <label for="alergia">
                     * Possii alergias ?
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="alergia_descricao" name="alergia_descricao" value="{{ $encontrista->alergia_descricao }}" placeholder="Detalhar a(s) alergia(s)." disabled>
         ...
         <div class="row">    
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <select class="form-select" id="espectro_autista" name="espectro_autista" required>                     
                     @foreach($simNao as $key => $dado)                     
                     <option value="{{ $key }}" {{ $encontrista->espectro_autista == $key ? 'selected' : '' }}>{{ $key }} - {{ $dado }}</option>                     
                     @endforeach
                  </select>
            ...
            <div class="col-12 col-md-6">
               <div class="form-floating mb-2">
                  <input type="text" class="form-control text-uppercase" id="espectro_autista_descricao" name="espectro_autista_descricao" value="{{ $encontrista->espectro_autista_descricao }}" placeholder="Detalhar a(s) espectro_autista(s)." disabled>
